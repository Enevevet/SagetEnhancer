...
\fbox{$\Phi_{\mathrm{2\rightarrow 2}}(t) = L_{2}i_{2}(t)$}. \\
...
\fbox{$\Phi_{\mathrm{2\rightarrow 1}}(t) = M_{\mathrm{21}}i_{2}(t)$}. \\
...
$\Phi_{\mathrm{1\longrightarrow 2}}(t) = N_{2}\Phi_{1\longrightarrow 1
...
\Gamma}i\overrightarrow{\mathrm{d}\ell}(M) \times \overrightarrow{B}(M,t)}}.
\\
