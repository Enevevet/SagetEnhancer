...
% \_\{(?=em)(.*?)\}
% \\fbox{\$\left(\left(.|\n\right)*?\right)\$}
%Â : ?\\\\ ?\n\$\left(\left(.\left(?!\left(\\mathcolorbox\right)\right)|\n\right)*?\right)\$ ?\.? ?\n?\\\\
...
\fbox{$\Phi_{\mathrm{2\rightarrow 2}}\left(t\right) = L_{2}i_{2}\left(t\right)$}. \\
$\Phi_{\mathrm{1\rightarrow 1}}\left(t\right)$ désigne le flux du champ magnétique
$\overrightarrow{B}_{1}$ à travers le circuit $\mathcal{C}_{1}$. \\
$\Phi_{\mathrm{2\rightarrow 2}}\left(t\right)$ désigne le flux du champ magnétique
...
\fbox{$\Phi_{\mathrm{2\rightarrow 1}}\left(t\right) = M_{\mathrm{21}}i_{2}\left(t\right)$}. \\
$\Phi_{\mathrm{1\rightarrow 2}}\left(t\right)$ désigne le flux du champ magnétique
$\overrightarrow{B}_{1}$ à travers le circuit $\mathcal{C}_{2}$. \\
$\Phi_{\mathrm{2\rightarrow 1}}\left(t\right)$ désigne le flux du champ magnétique
...
on posera : \fbox{$M_{\mathrm{12}} =M_{\mathrm{21}} =M$}. \\
...
$\Phi\left(t\right) = N\Phi_{\mathrm{1\,spire}}$.
...
\mu_{0}\frac{NSI}{\ell}$. Or, $\Phi_{1}\left(t\right) = N\Phi_{\mathrm{1\,spire}}$, donc
...
$\Phi_{\mathrm{1\longrightarrow 2}}\left(t\right) = N_{2}\Phi_{1\longrightarrow 1
spire\, \mathrm{d}e\,2}$, donc le flux du champ magnétique créé par le grand
solénoïde à travers le petit solénoïde est : $\Phi_{\mathrm{1\longrightarrow 2}}\left(t\right) = \mu_{0}\frac{NN_{2}S_{2}I}{\ell}\cos\theta$.\\
Par définition du coefficient d'inductance mutuelle, on écrit :
$\Phi_{\mathrm{1\longrightarrow 2}}\left(t\right)
...
\mathrm{Espace}}w_{m}\left(M,t\right)\mathrm{d}V\left(M\right)$ avec $w_{m} = \frac{B^{2}}{2\mu_{0}}$, donc
...
\overrightarrow{v}_{\mathrm{/R}}\left(M\right)$, $\overrightarrow{v'} =
\overrightarrow{v}_{\mathrm{/R'}}\left(M\right)$, $\overrightarrow{v}_{e} =
\overrightarrow{v}_{\mathrm{/R}}\left(O'\right)$) : $\overrightarrow{v} =
...
. \\
Il vient : \fbox{$e\left(t\right)=-v\left(t\right)B\ell$}. \\
...
Il vient : \fbox{$i\left(t\right) = -\frac{vB\ell}{R}$}. \\
...
barre : \fbox{$v\left(t\right) = v_{0}e^{-\frac{t}{\tau}}$}.
\end{itemize}
...
Avec la CI, $v\left(t=0\right) = 0$, il vient : \fbox{$v\left(t\right) =
...
donc $e\left(t\right) < 0$, donc $i_{\mathrm{in\mathrm{d}}uit} < 0$ : $i_{\mathrm{in\mathrm{d}}uit}$ s'oppose ici à
...
\overrightarrow{v}_{\mathrm{/R}}\left(M\right)=\overrightarrow{v}$ la vitesse de la
